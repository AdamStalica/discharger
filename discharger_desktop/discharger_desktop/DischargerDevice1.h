...
public:
	...
	DischargerDevice1(QObject * parent, const QString & com, db::TestType testType, db::CurrentSource currSource);
	~DischargerDevice1();
...
private:
	void handleWarning(dischargerDevice::Warning warn);
	void handleError(dischargerDevice::Error err);
